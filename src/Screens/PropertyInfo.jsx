                ...
                <div className='sm:w-[60%] space-y-8'>
                    ...
                    <div className='w-full bg-white rounded-md '>
                        <div className="flex flex-col justify-evenly items-start h-full p-5">
                            ...
                            <p className="text-base text-gray-700 text-justify">{state?.item?.description}</p>
                        </div>
                    </div>
                    <div className='w-full bg-white rounded-md '>
                        <div className="flex flex-col justify-evenly items-start h-full p-5">
                    ...
                    <div className='w-full bg-white rounded-md '>
                        <div className="flex flex-col justify-evenly items-start h-full p-5">
                            ...
                            <div className=" rounded-md bg-white w-full  flex justify-center">
                                <youtube-video
                                    src={state?.item?.property_video_url}
                                    controls
                                />
                            </div>
                        </div>
                    ...
                    <div className='w-full bg-white rounded-md '>
                        <div className="flex flex-col justify-evenly items-start h-full p-5">
                            ...
                            <iframe src={state?.item?.google_map_link} className='w-full h-[300px]' allowFullScreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" ></iframe>
                        </div>
                    </div>
                    <div className='w-full bg-white rounded-md '>
                        <div className="flex flex-col justify-evenly items-start h-full p-5">
                            ...
                            <div className='flex flex-wrap justify-evenly '>

                                {
                                    state?.item?.property_images?.map((item, index) => (
                                        <img src={baseurl + item?.image} className=" m-2 w-[300px] text-base font-bold px-2 py-1 rounded" />
                                    ))
                                }
                            </div>
                        </div>
