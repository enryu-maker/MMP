      ...
      <div className="sm:w-[78%] w-[92%] bg-white rounded-md my-20 shadow-lg  ">
        <div className="flex flex-col justify-evenly items-start h-full p-5">
          <p className="text-base text-gray-700 text-justify">
            Welcome to MakeMyProperties, your trusted partner in the realm of
            real estate. At MakeMyProperty, we believe that finding the perfect
            home is more than a transaction, it's about creating a seamless and
